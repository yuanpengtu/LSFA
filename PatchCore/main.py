...
def run_3d_ads(args):
    ...
    classes = [allclass[args.classname]]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--method_name', default='Point_MAE', type=str,
                        choices=['DINO', 'Point_MAE', 'DINO+Point_MAE+cat', 'Fusion', 'DINO+Point_MAE',
    ...
    parser.add_argument('--epoch', default=0, type=int,
                        help='Point groups number of Point Transformer.')
    parser.add_argument('--caption', default='no caption', type=str,
                        help='Point groups number of Point Transformer.') 
    parser.add_argument('--weightpath', default='no caption', type=str,
                        help='Point groups number of Point Transformer.')        
    parser.add_argument('--modality', default='xyz', type=str,
                        help='Point groups number of Point Transformer.')    
    parser.add_argument('--accfile', default='./results/acc.txt', type=str,
                        help='File for accuracy input.')       
