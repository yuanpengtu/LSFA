...
class MVTec3DTrain(MVTec3D):
    ...
    def __getitem__(self, idx):
        ...
        return (img, resized_organized_pc, resized_depth_map_3channel, img_rotate, resized_organized_pc_rotate, \
            (xyz_feat,center,neighbor_idx,nonzero_indices,unorganized_pc_no_zeros,center_idx, rgb_patch, interpolated_pc), rgb_path.replace('.png', 'rgb.pt'),tiff_path.replace('.tiff', 'point.pt')), label
...
class MVTec3DTest(MVTec3D):
    ...
    def __getitem__(self, idx):
        ...
        return (img, resized_organized_pc, resized_depth_map_3channel, (xyz_feat,center,neighbor_idx,nonzero_indices,unorganized_pc_no_zeros,center_idx, rgb_patch, interpolated_pc), img_path[0].replace('.png', 'rgb.pt'), img_path[1].replace('.tiff', 'point.pt')), gt[:1], label, rgb_path
